...
void Armor::Draw()
{
    ...
    line(img, point2d[1], point2d[2], Scalar(255, 255, 255), 2, 8, 0);
...
void Armor::Draw2()
{
    ...
    putText(dst, "yaw_angle:" + ToString(this->yaw_angle) + "degree", Point(10, 150), 2, 1, Scalar(255, 255, 255));
    putText(dst, "pitch_angle:" + ToString(this->pitch_angle) + "degree", Point(10, 250), 2, 1, Scalar(255, 255, 255));
